...
ActiveRecord::Schema[7.0].define(version: 20_220_823_183_339) do
  ...
  create_table 'team_invitations', force: :cascade do |t|
    ...
    t.index %w[team_id user_id], name: 'index_team_invitations_on_team_id_and_user_id', unique: true
  ...
  create_table 'tournament_participating_teams', force: :cascade do |t|
    ...
    t.index %w[tournament_id team_id], name: 'index_participating_teams_to_not_be_duplicates', unique: true
  ...
  create_table 'tournaments', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[created_at sport], name: 'index_tournaments_on_created_at_and_sport'
